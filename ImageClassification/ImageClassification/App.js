...
export default class App extends Component<{}> {
  ...
  render() {
    ...
    if (this.state.bestMatch) {
      if (this.state.bestMatch && this.state.bestMatch.identifier && this.state.bestMatch.identifier == "cemetery") {
    ...
    return (
      <View style={styles.container}>
          <CoreMLImage modelFile="ImageClassification" onClassification={(evt) => this.onClassification(evt)}>
              <View style={styles.container}>
